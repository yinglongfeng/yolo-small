...
class YOLOLayer(nn.Module):
    def __init__(self, anchors, nc, stride,point_num=0,onnx_export=False):
        ...
        # print("self.anchor_wh: ", self.anchor_wh)
        print("self.anchors: ", self.anchors, self.stride)
    ...
    def forward(self, p):
        ...
        if self.training:
            ...
            # print("self anchor wh", self.anchor_wh)
...
class DarknetWithShh(nn.Module):
    ...
    def forward(self, x):
        ...
        # print("yolo_out1: ", yolo_out1.shape)
        # print("yolo_out2: ", yolo_out2.shape)
        # print("yolo_out3: ", yolo_out3.shape)
        ...
        if self.training:  # train
            ...
            print( "x.shape: ", len(x))
            print("x: inference add yolo decode(sigmoid exp simgoid)  p: inference  ",x[0].shape, p[0].shape)
            print(x[1].shape, p[1].shape)
            print("yolo_s8 decode: ", x[2].shape, p[2].shape, x[2][0][0])

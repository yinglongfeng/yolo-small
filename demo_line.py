...
pattern = [(0,1), (1,2), (0,3), (3,4), (0,5), (5,6), (0,7), (7,8), (0,9),(9,10)]
...
for path in imgs:
    ...
    for b in det:
        ...
        for i in range(5, 5+point_num*2, 2):
            ...
            # print("hand p: {}, {}, {} ".format((i-5)//2, b[i], b[i+1]))
        
        print(b[5], b[5+1])
        print(pattern[0][0], pattern[0][1])
        for i in range(len(pattern)):
            # print(pattern[i][0], pattern[i][1])
            idx0 = pattern[i][0]
            idx1 = pattern[i][1]
            p0 = (b[5+2*idx0], b[5+2*idx0+1])
            p1 = (b[5+2*idx1], b[5+2*idx1+1])
            # print(p0, p1)
            cv2.line(orig_image, p0, p1, (0,255,255), 1)

        # cv2.line(orig_image, (b[pattern[0][0]], b[pattern[0][1]]), (b[5+pattern[1][0]], b[5+pattern[1][1]]), (0,255,255), 1)

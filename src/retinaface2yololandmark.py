'''
Author: not 冯颖龙
Date: 2020-07-06 10:20:41
LastEditTime: 2020-08-07 15:29:49
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /yolo-face-with-landmark-master/src/retinaface2yololandmark.py
'''
import os
import cv2

txt_path = "/home/fyl/data/retinaface/train/label.txt"
save_path = "/home/fyl/data/retinaface/yololandmark_wider_train/"
...
for path,word in zip(imgs_path,words):
    ...
    print(save_path + save_image_name + ".jpg")
